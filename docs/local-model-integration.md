...
This guide explains how to add a new locally-run model to the Vocally desktop app. It covers the complete flow from UI settings to Rust inference, and explains how to adapt the patterns for different model types.
...
- **macOS**: `~/Library/Application Support/Vocally/models/`
- **Windows**: `C:\Users\{user}\AppData\Roaming\Vocally\models\`
- **Linux**: `~/.config/Vocally/models/`
