...
- During each build the Tauri config is patched so the updater reads the correct channel-specific manifest:
  - Desktop dev channel → `https://github.com/SL-IT-AMAZING/vocally/releases/download/desktop-dev/latest.json`
  - Desktop prod channel → `https://github.com/SL-IT-AMAZING/vocally/releases/download/desktop-prod/latest.json`
...
4. Confirm the dev manifest is accessible at `https://github.com/SL-IT-AMAZING/vocally/releases/download/desktop-dev/latest.json`.
...
4. Confirm the production manifest: `https://github.com/SL-IT-AMAZING/vocally/releases/download/desktop-prod/latest.json`.
